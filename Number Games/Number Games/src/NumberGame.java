    ...
    public static void main(String[] args) throws Exception {
        ...
        while(roundNumber<=numberOfRounds)
        {
            ...
            while(true) {
                ...
                {
                    System.out.println("You have reached the maximum attempt sorry! Try again.");
                    break;
                }
                int guess=0;
                while(true) {
                ...
                if(guess==target) {
                    System.out.println("Congrats you have guessed the generated number in "+attempt+" attempt");
                    won = true;
                    break;
                }
